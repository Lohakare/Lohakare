...
<!-- Mirrored from akademi.dexignlab.com/xhtml/emailInbox by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:40 GMT -->
<head>
									...
									<div class="dropdown-menu dropdown-menu-end pb-0" style="">
										<div class="card mb-0">
											...
											<div class="card-body p-3">
												...
												<a href="emailInbox" class="dropdown-item ai-icon ">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"/>
					...
					<div class="row gx-0">
						...
						<div class="col-xl-2 col-xxl-3 col-lg-3">
							<div class="email-left-box dlab-scroll" id="email-left">
								<div class="p-0">
									<a href="emailCompose" class="btn text-white btn-block"><i class="fa-solid fa-plus me-2"></i>Compose Email</a>
								</div>
								<div class="mail-list rounded ">
									<a href="emailInbox" class="list-group-item active"><i class="fa-regular fa-envelope align-middle"></i>Inbox <span class="badge badge-purple badge-sm float-end rounded">2</span> </a>
								...
								<div class="mail-list rounded overflow-hidden mt-4">
									...
									<a href="emailInbox" class="list-group-item change">Work </a>
									<a href="emailInbox" class="list-group-item change">Private </a>
									<a href="emailInbox" class="list-group-item change">Support </a>
									<a href="emailInbox" class="list-group-item change">Social </a>
								</div>
							</div>
						</div>
						<!--/column-->
									...
									<div class="email-list dlab-scroll" id="emails">
										<div class="message">
											<div>
												...
												<a href="emailRead" class="col-mail col-mail-2">
