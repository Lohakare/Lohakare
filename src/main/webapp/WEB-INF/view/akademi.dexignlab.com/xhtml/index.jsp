...
<!-- Mirrored from akademi.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:48:46 GMT -->
<head>
    <meta charset="utf-8">
...
<!-- FAVICONS ICON -->
	...
	<link href="/akademi.dexignlab.com/xhtml/vendor/wow-master/css/libs/animate.css" rel="stylesheet">
	<link href="/akademi.dexignlab.com/xhtml/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link rel="stylesheet" href="/akademi.dexignlab.com/xhtml/vendor/bootstrap-select-country/css/bootstrap-select-country.min.css">
	<link rel="stylesheet" href="/akademi.dexignlab.com/xhtml/vendor/jquery-nice-select/css/nice-select.css">
	<link href="/akademi.dexignlab.com/xhtml/vendor/datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
	
	 <link href="/akademi.dexignlab.com/xhtml/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	<!--swiper-slider-->
	<link rel="stylesheet" href="/akademi.dexignlab.com/xhtml/vendor/swiper/css/swiper-bundle.min.css">
	<!-- Style css -->
	<link href="https://fonts.googleapis.com/css2?family=Material+Icons" rel="stylesheet">
    <link href="/akademi.dexignlab.com/xhtml/css/style.css" rel="stylesheet">
    ...
    <div id="main-wrapper" class="wallet-open active">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="adminIndex" class="brand-logo">
				<img src="/img/sanskarLogo.png" class="img-responsive circle-logo center-block" style="height: 40px; width: 40px;">
								...
								<ul class="contacts">
									...
									<li class="active dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dlab-scroll" id="DLAB_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="/akademi.dexignlab.com/xhtml/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="/akademi.dexignlab.com/xhtml/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										...
										<div class="card-body px-0">
											...
											<div class="dlab-scroll px-3 mt-3 height300">
												<ul class="d-flex align-items-center mb-3">
													<li>
														<img src="/akademi.dexignlab.com/xhtml/images/avatar/1.jpg" class="avatar avatar-sm" alt="">
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="/akademi.dexignlab.com/xhtml/images/avatar/1.jpg">
													</div>
								...
								<div class="dropdown header-profile2">
									<a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											...
											<img id="adminProfilPictureMain" src="" alt="/akademi.dexignlab.com/xhtml/images/user.jpg" alt="">
										</div>
									</a>
										...
										<div class="card mb-0">
											<div class="card-header p-3">
												<ul class="d-flex align-items-center">
													<li>
														<img id="adminProfilPicture" src="" alt="/akademi.dexignlab.com/xhtml/images/user.jpg" class="ms-0" alt="">
													</li>
													<li class="ms-2">
														<h4 class="mb-0" id="adminUserNameDashboard"></h4>
														<span id="adminUserCode"></span>
													</li>
												</ul>
											...
											<div class="card-footer text-center p-3">
												<a onclick="logoutSession();" class="dropdown-item ai-icon btn btn-primary light">
				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="adminIndex">Dashboard Light</a></li>
							<li><a onclick="dartLight();">Dashboard Dark</a></li>
					...
					<ul aria-expanded="false">
						...
						<li><a href="teacherDetails">Teacher Detail</a></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="foodDetial">Food Detail</a></li>
						</ul>
					...
					<ul aria-expanded="false">
						...
						<li><a href="celandar">Calendar</a></li>	
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="appProfile">Profile</a></li>
							<li><a href="editProfile">Edit Profile</a></li>
							<li><a href="postDetails">Post Details</a></li>
							<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Email</a>
								<ul aria-expanded="false">
									<li><a href="emailCompose">Compose</a></li>
									<li><a href="emailInbox">Inbox</a></li>
									<li><a href="emailRead">Read</a></li>
								</ul>
							</li>
							<li><a href="appCalender">Calendar</a></li>
							<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Shop</a>
								<ul aria-expanded="false">
									<li><a href="ecomProductGrid">Product Grid</a></li>
									<li><a href="ecomProductList">Product List</a></li>
									<li><a href="ecomProductDetail">Product Details</a></li>
									<li><a href="ecomProductOrder">Order</a></li>
									<li><a href="ecomCheckout">Checkout</a></li>
									<li><a href="ecomInvoice">Invoice</a></li>
									<li><a href="ecomCustomers">Customers</a></li>
								</ul>
							</li>
						</ul>
					</li>
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="chartFlot">Flot</a></li>
							<li><a href="chartMorris">Morris</a></li>
							<li><a href="chartChartjs">Chartjs</a></li>
							<li><a href="chartChartist">Chartist</a></li>
							<li><a href="chartSparkline">Sparkline</a></li>
							<li><a href="chartPeity">Peity</a></li>
						</ul>
					</li>
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="uiAccordion">Accordion</a></li>
							<li><a href="uiAlert">Alert</a></li>
							<li><a href="uiBadge">Badge</a></li>
					...
					<div class="card bg-transparent mb-1">
						...
						<div class="card-body height450 dlab-scroll loadmore-content recent-activity-wrapper p-3 pt-2" id="RecentActivityContent">
							...
							<div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic1.jpg" alt="" width="50" class="avatar">
								</span>
								<div class="user-info">
							...
							<div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic2.jpg" alt="" width="50" class="avatar">
								</span>
								<div class="user-info">
							...
							<div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic3.jpg" alt="" class="avatar">
								</span>
								<div class="user-info">
							...
							<div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic4.jpg" alt="" class="avatar">
								</span>
								<div class="user-info">
							...
							<div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic5.jpg" alt="" class="avatar">
								</span>
								<div class="user-info">
						...
						<div class="card-body height450 dlab-scroll p-0 px-3" id="messageContent">
							...
							<div class="d-flex student border-bottom">
								<div class="d-flex align-items-center">
									<span class="dz-media">
										<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic1.jpg" alt="" class="avatar">
									</span>
									<div class="user-info">
										<h6 class="name"><a href="app-profile.html">Samantha William</a></h6>
							...
							<div class="d-flex student border-bottom">
								<div class="d-flex align-items-center">
									<span class="dz-media">
										<img src="/akademi.dexignlab.com/xhtml/images/profile/small/pic2.jpg" alt="" class="avatar">
									</span>
									<div class="user-info">
										<h6 class="name"><a href="app-profile.html">Tony Soap</a></h6>
										<span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
					...
					<div class="card tags bg-transparent mb-0">
						...
						<div class="card-body  p-3 py-1 ">	
							<div class="card-body-inner food">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/food/pic1.jpg" alt="" class="avatar">
								</span>
								<div class="user-info">
							...
							<div class="card-body-inner food">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/food/pic2.jpg" alt="" class="avatar">
								</span>
								<div class="user-info">
							...
							<div class="card-body-inner food">
								<span class="dz-media">
									<img src="/akademi.dexignlab.com/xhtml/images/food/pic3.jpg" alt="" class="avatar">
								</span>
								<div class="user-info">
								...
								<table id="example-1" class="display" style="min-width: 845px">
									...
									<tbody>
										<tr>
											<td>
												<div class="trans-list">
													<img src="/akademi.dexignlab.com/xhtml/images/trans/1.jpg" alt="" class="avatar avatar-sm me-3">
										...
										<tr>
											<td>
												<div class="trans-list">
													<img src="/akademi.dexignlab.com/xhtml/images/trans/2.jpg" alt="" class="avatar avatar-sm me-3">
													<h4>Tony Soap</h4>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="trans-list">
													<img src="/akademi.dexignlab.com/xhtml/images/trans/3.jpg" alt="" class="avatar avatar-sm me-3">
													<h4>Jordan Nico</h4>
												</div>
											</td>
											...
											<td>
												<div class="trans-list">
													<img src="/akademi.dexignlab.com/xhtml/images/trans/4.jpg" alt="" class="avatar avatar-sm me-3">
													<h4>Karen Hope</h4>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="trans-list">
													<img src="/akademi.dexignlab.com/xhtml/images/trans/5.jpg" alt="" class="avatar avatar-sm me-3">
													<h4>Nadila Adja</h4>
												</div>
											</td>
		...
		***********************************-->
		<div class="footer footer-outer">
			<div class="copyright">
				<p>Copyright � Designed &amp; Developed by <a href="" target="_blank">mrunallohakare@gmail.com</a> 2024</p>
			</div>
		</div>
...
<!--***********************************-->
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="/akademi.dexignlab.com/xhtml/vendor/global/global.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/chart.js/Chart.bundle.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<!-- Apex Chart -->
	<script src="/akademi.dexignlab.com/xhtml/vendor/apexchart/apexchart.js"></script>
	<!-- Chart piety plugin files -->
    <script src="/akademi.dexignlab.com/xhtml/vendor/peity/jquery.peity.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
	<!--swiper-slider-->
	<script src="/akademi.dexignlab.com/xhtml/vendor/swiper/js/swiper-bundle.min.js"></script>
	
	
    <!-- Datatable -->
    <script src="/akademi.dexignlab.com/xhtml/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="/akademi.dexignlab.com/xhtml/js/plugins-init/datatables.init.js"></script>

	<!-- Dashboard 1 -->
	<script src="/akademi.dexignlab.com/xhtml/js/dashboard/dashboard-1.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/wow-master/dist/wow.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/bootstrap-datetimepicker/js/moment.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/datepicker/js/bootstrap-datepicker.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/bootstrap-select-country/js/bootstrap-select-country.min.js"></script>
	
	<script src="/akademi.dexignlab.com/xhtml/js/dlabnav-init.js"></script>
    <script src="/akademi.dexignlab.com/xhtml/js/custom.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/js/demo.js"></script>
    <script src="/akademi.dexignlab.com/xhtml/js/styleSwitcher.js"></script>
...
function sessionGet(){
        ...
        $.ajax({
            url: "/dashboard/sessionDashboard",
            method: "GET", // Use uppercase "GET"
            dataType: "json",
            contentType: "application/json", // Set content type if needed
            success: function (resp) {
                console.log(JSON.stringify(resp)); 
                $("#adminUserNameDashboard").text(resp.adminName);
                $("#adminUserCode").text(resp.AdminUserId);
                $("#adminProfilPicture,#adminProfilPictureMain").attr('src', resp.AdminProfielPicture);
                userPrimerykey = resp.adminId;
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:23 GMT -->
</html>