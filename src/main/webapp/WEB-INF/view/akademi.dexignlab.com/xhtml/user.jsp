...
<!-- Mirrored from akademi.dexignlab.com/xhtml/user.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:54 GMT -->
<head>
...
<!-- FAVICONS ICON -->
	...
	<link href="/akademi.dexignlab.com/xhtml/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="/akademi.dexignlab.com/xhtml/images/avatar/10.jpg" alt="" class="avatar avatar-xxl">
										</div>
										<div>
								...
								<div class="row mt-2">
										...
										<ul class="student-details">
											<li class="me-2">
												<a class="icon-box bg-secondary">
													<img src="/akademi.dexignlab.com/xhtml/images/profile.svg" alt="">
												</a>
											</li>
											<li>
												<span>Parents:</span>
									...
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										...
										<ul class="student-details">
											<li class="me-2">
												<a class="icon-box bg-secondary">
													<img src="/akademi.dexignlab.com/xhtml/images/svg/location.svg" alt="">
												</a>	
									...
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										<ul class="student-details">
											<li class="me-2">
												<a class="icon-box bg-secondary">
													<img src="/akademi.dexignlab.com/xhtml/images/svg/phone.svg" alt="">
												</a>	
											</li>
									...
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										<ul class="student-details">
											<li class="me-2">
												<a class="icon-box bg-secondary">
													<img src="/akademi.dexignlab.com/xhtml/images/svg/email.svg" alt="">
												</a>	
								...
								<div class="dz-scroll">
									<ul class="timeline-active">
										<li class="d-flex timeline-list">
											<div class="dz-media">
												<img src="/akademi.dexignlab.com/xhtml/images/profile/14.jpg" alt="" class="avatar avatar-sm">
											</div>
											<div class="panel">
										...
										<li class="d-flex timeline-list">
											<div class="dz-media">
												<img src="/akademi.dexignlab.com/xhtml/images/profile/18.jpg" alt="" class="avatar avatar-sm">
											</div>
											<div class="panel">
												<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
										...
										<li class="d-flex timeline-list">
											<div class="dz-media">
												<img src="/akademi.dexignlab.com/xhtml/images/profile/19.jpg" alt="" class="avatar avatar-sm">
											</div>
											<div class="panel">
												<a class="timeline-panel text-muted d-flex align-items-center mb-0" href="#">
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/user.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:56 GMT -->
</html>