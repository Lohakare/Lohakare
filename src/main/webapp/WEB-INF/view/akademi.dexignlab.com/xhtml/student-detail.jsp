...
<!-- Mirrored from akademi.dexignlab.com/xhtml/student-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:44 GMT -->
<head>
...
<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="/akademi.dexignlab.com/xhtml/image/png" href="img/sanskarLogo.png" >
								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="/akademi.dexignlab.com/xhtml/images/avatar/9.jpg" alt="" class="avatar avatar-xxl">
										</div>
										<div>
								...
								<div class="card h-auto schedule-card">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/1.jpg" class="avatar avatar-lg" alt="">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card h-auto schedule-card-1">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/2.jpg" class="avatar avatar-lg" alt="">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card h-auto schedule-card-2">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/3.jpg" class="avatar avatar-lg" alt="">
											</div>
										</div>
								...
								<div class="card h-auto schedule-card-3">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<img src="/akademi.dexignlab.com/xhtml/images/avatar/4.jpg" class="avatar avatar-lg" alt="">
											</div>
										</div>
									</div>
								</div>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/student-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:45 GMT -->
</html>