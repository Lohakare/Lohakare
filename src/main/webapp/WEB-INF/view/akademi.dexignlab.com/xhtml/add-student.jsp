...
<!-- Mirrored from akademi.dexignlab.com/xhtml/add-student.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:45 GMT -->
<head>
...
<!-- FAVICONS ICON -->
	...
	<link href="/akademi.dexignlab.com/xhtml/vendor/bootstrap-datepicker-master/css/bootstrap-datepicker.min.css" rel="stylesheet">
...
<body>
							...
							<div class="card-body contacts_body p-0 dlab-scroll  " id="DLAB_W_Contacts_Body">
								<ul class="contacts">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/akademi.dexignlab.com/xhtml//avatar/2.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
										...
										<label class="form-label text-primary">Photo<span class="required">*</span></label>
										 <div class="avatar-upload">
											<div class="avatar-preview">
												<div id="imagePreview" style="background-image: url(/akademi.dexignlab.com/xhtml/images/no-img-avatar.png);"> 			
												</div>
											</div>
    ...
    ***********************************-->
	...
	<script src="/akademi.dexignlab.com/xhtml/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	  <script src="/akademi.dexignlab.com/xhtml/vendor/moment/moment.min.js"></script>
	

	<script src="/akademi.dexignlab.com/xhtml/vendor/bootstrap-datepicker-master/js/bootstrap-datepicker.min.js"></script>
...
$("#imageUpload").change(function() {
	...
	$('.remove-img').on('click', function() {
		var imageUrl = "/akademi.dexignlab.com/xhtml/images/no-img-avatar.png";
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/add-student.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:46 GMT -->
</html>