...
<!-- Mirrored from akademi.dexignlab.com/xhtml/chart-chartist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:50:08 GMT -->
<head>
...
<body>
								...
								<div class="dropdown header-profile2">
									<a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
										<div class="header-info2 d-flex align-items-center">
											...
											<img id="adminProfilPictureMain" src="" alt="/akademi.dexignlab.com/xhtml//akademi.dexignlab.com/xhtml/images/user.jpg" alt="">
										</div>
									</a>
										...
										<div class="card mb-0">
											<div class="card-header p-3">
												<ul class="d-flex align-items-center">
													<li>
														<img id="adminProfilPicture" src="" alt="/akademi.dexignlab.com/xhtml//akademi.dexignlab.com/xhtml/images/user.jpg" class="ms-0" alt="">
													</li>
													<li class="ms-2">
    ...
    ***********************************-->
    ...
    <script src="/akademi.dexignlab.com/xhtml/vendor/chartist/js/chartist.min.js"></script>
    <script src="/akademi.dexignlab.com/xhtml/vendor/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>
	<script src="/akademi.dexignlab.com/xhtml/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>
	
    <script src="/akademi.dexignlab.com/xhtml/js/plugins-init/chartist-init.js"></script>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/chart-chartist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:50:09 GMT -->
</html>