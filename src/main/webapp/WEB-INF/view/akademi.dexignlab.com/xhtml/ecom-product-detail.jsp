...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:50:02 GMT -->
<head>
...
<!-- FAVICONS ICON -->
    ...
    <link rel="stylesheet" type="text/css" href="/akademi.dexignlab.com/xhtml/vendor/star-rating/star-rating-svg.css">
...
<body>
                                    ...
                                    <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                        ...
                                        <div class="tab-content" id="myTabContent">
										  <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
												 <img class="img-fluid rounded  " src="/akademi.dexignlab.com/xhtml/images/product/1.jpg" alt="">
										  </div>
										  <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
												<img class="img-fluid rounded " src="/akademi.dexignlab.com/xhtml/images/product/2.jpg" alt="">
										  </div>
										  <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
											 <img class="img-fluid rounded" src="/akademi.dexignlab.com/xhtml/images/product/3.jpg" alt="">
										  </div>
										  <div class="tab-pane fade" id="end-tab-pane" role="tabpanel" aria-labelledby="end-tab" tabindex="0">
											 <img class="img-fluid rounded" src="/akademi.dexignlab.com/xhtml/images/product/4.jpg" alt="">
										  </div>
										  
										</div>
									   <ul class="nav nav-tabs slide-item-list mt-3" id="myTab" role="tablist">
										  <li class="nav-item" role="presentation">
											<a href="#first" class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"  role="tab" aria-controls="home-tab-pane" aria-selected="true"><img class="img-fluid me-2 rounded" src="/akademi.dexignlab.com/xhtml/images/tab/1.jpg" alt="" width="80"></a>
										  </li>
										  <li class="nav-item" role="presentation">
											<a href="#second" class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"  role="tab" aria-controls="profile-tab-pane" aria-selected="false"><img class="img-fluid me-2 rounded" src="/akademi.dexignlab.com/xhtml/images/tab/2.jpg" alt="" width="80"></a>
										  </li>
										  <li class="nav-item" role="presentation">
											<a href="#third" class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" role="tab" aria-controls="contact-tab-pane" aria-selected="false"><img class="img-fluid me-2 rounded" src="/akademi.dexignlab.com/xhtml/images/tab/3.jpg" alt="" width="80"></a>
										  </li>
										  <li class="nav-item" role="presentation">
											<a href="#for" class="nav-link" id="end-tab" data-bs-toggle="tab" data-bs-target="#end-tab-pane"  role="tab" aria-controls="end-tab-pane" aria-selected="false"><img class="img-fluid  rounded" src="/akademi.dexignlab.com/xhtml/images/tab/4.jpg" alt="" width="80"></a>
										  </li>
								...
								<div class="modal-body">
									<form>
										<div class="text-center mb-4">
											<img class="img-fluid rounded" width="78" src="/akademi.dexignlab.com/xhtml/images/avatar/1.jpg" alt="DexignZone">
										</div>
										<div class="mb-3">
    ...
    ***********************************-->
	...
	<!-- Rating -->
	<script src="/akademi.dexignlab.com/xhtml/vendor/star-rating/jquery.star-rating-svg.js"></script>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/ecom-product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:50:03 GMT -->
</html>