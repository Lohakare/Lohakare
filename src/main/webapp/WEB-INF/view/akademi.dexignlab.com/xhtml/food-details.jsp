...
<!-- Mirrored from akademi.dexignlab.com/xhtml/food-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:52 GMT -->
<head>
						...
						<div class="card">
							<div class="card-body">
								<ul class="d-sm-flex d-block align-items-start justify-content-between mb-5">
									<li class="food-media">
										<img src="/akademi.dexignlab.com/xhtml/images/food/pic6.jpg" class="rounded" alt="">
									</li>
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="stud-comment">
									<img src="/akademi.dexignlab.com/xhtml/images/quotes.svg" alt="">
									<div>
									...
									<ul class="d-flex align-items-center">
										<li><img src="/akademi.dexignlab.com/xhtml/images/avatar/1.png" class="avatar" alt=""></li>
										<li class="ms-3">
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="stud-comment">
									...
									<ul class="d-flex align-items-center">
										<li><img src="/akademi.dexignlab.com/xhtml/images/avatar/2.png" class="avatar" alt=""></li>
										<li class="ms-3">
						...
						<div class="card h-auto">
							<div class="card-body">
								<div class="stud-comment">
									...
									<ul class="d-flex align-items-center">
										<li><img src="/akademi.dexignlab.com/xhtml/images/avatar/3.png" class="avatar" alt=""></li>
										<li class="ms-3">
									...
									<div class="table-responsive">
										<table class="table table-details">
											...
											<td Style="width:100px;">
												<div class="food-menu">
													<img class="me-3 rounded avatar avatar-xl"  src="/akademi.dexignlab.com/xhtml/images/food/pic1.jpg" alt="DexignZone">
													<div class="food-info">
											...
											<td>
												<img src="/akademi.dexignlab.com/xhtml/images/circle.svg" alt="">
											</td>
											<td class="text-end">
												<div class="dropdown custom-dropdown">
													<div class="btn sharp btn-light " data-bs-toggle="dropdown">
										...
										<tr>
											<td Style="width:100px;">
												<div class="food-menu">
													<img class="me-3 rounded avatar avatar-xl"  src="/akademi.dexignlab.com/xhtml/images/food/pic2.jpg" alt="DexignZone">
													<div class="food-info">
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/food-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:49:53 GMT -->
</html>