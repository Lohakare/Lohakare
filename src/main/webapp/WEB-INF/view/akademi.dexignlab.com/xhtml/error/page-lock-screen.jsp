...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-lock-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Feb 2024 12:50:36 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div class="login-aside text-center  d-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				<div class="text-center mb-lg-4 mb-2 pt-5 logo">
					<!--<img src="/akademi.dexignlab.com/xhtml/images/logo-white.png" alt="">-->
					<h6 style="font-size: 30px;color: white;">Sanskar</h6>
				</div>
				<h3 class="mb-2 text-white">Welcome back!</h3>
				<p class="mb-4">User Experience & Interface Design <br>Strategy SaaS Solutions</p>
			</div>
			<div class="aside-image position-relative" style="background-image:url(/akademi.dexignlab.com/xhtml/images/background/pic-2.png);">
				<img class="img1 move-1" src="/akademi.dexignlab.com/xhtml/images/background/pic3.png" alt="">
				<img class="img2 move-2" src="/akademi.dexignlab.com/xhtml/images/background/pic4.png" alt="">
				<img class="img3 move-3" src="/akademi.dexignlab.com/xhtml/images/background/pic5.png" alt="">
