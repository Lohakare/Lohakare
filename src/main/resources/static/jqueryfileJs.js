...
function calcSHA1(n) {
    for (var c = str2blks_SHA1(n), o = new Array(80), r = 1732584193, u = -271733879, f = -1732584194, e = 271733878, s = -1009589776, i, h = 0; h < c.length; h += 16) {
        var l = r
          ...
          , p = s;
        for (i = 0; i < 80; i++)
            o[i] = i < 16 ? c[h + i] : rol(o[i - 3] ^ o[i - 8] ^ o[i - 14] ^ o[i - 16], 1),
            t = add(add(rol(r, 5), ft(i, u, f, e)), add(add(s, o[i]), kt(i))),
            s = e,
            e = f,
            f = rol(u, 30),
            u = r,
...
function keyup_removeclass(n, t) {
    if ((t == "undefined" || t == null || t == "") && (t = "sp-error"),
    varKey = window.event ? window.event.keyCode : n.which,
    varKey == 9 || varKey == 13)
        return !1;
    var i = n.target.id
      , r = document.getElementById(i).value;
    (r != "" || r != "0") && (document.getElementById(t).innerHTML = "",
    ...
    param.length > 1 ? $.post(r, function(n) {
        $("#" + i + "").autocomplete({
            ...
            select: function(n, r) {
                ...
                typeof ModuleSearchResponse == "function" && ModuleSearchResponse(t);
...
function ShowingImagePreview(n, t) {
    var r = n.files[0].name.split("."), i;
    if ($.inArray(r[1], ["jpeg", "jpg", "JPG", "JPEG"]) == -1)
        return document.getElementById(n.id).value = "",
        fAlert("You can upload a JPG format only."),
        !1;
    if (n.files[0].size > 2e4)
        return document.getElementById(n.id).value = "",
        fAlert("Maximum size of 20 kb"),
        !1;
    n.files && n.files[0] && (i = new FileReader,
    i.onload = function(n) {
...
function jsonPostdata(n, t) {
    var r = "/" + n[0] + "/" + n[1] + "", u = n[2], i;
    t != null && (i = t.target.id);
    $.post(r, u, function(n) {
        n.Message != "" && (n.Message == "Login Again" ? location.href = "/" : (n.Message == "Save Successfully" || n.Message == "Saved Successfully" || n.Message == "S" ? (fAlert("Saved Successfully"),
        filllist(n.Data)) : n.Message == "Updated Successfully" || n.Message == "U" ? (fAlert(n.Message),
        filllist(n.Data)) : fAlert(n.Message),
        t != null && t.target.type == "submit" && $("#" + i + "").attr("disabled", !1)))
    }, "json")
}
function jsongetdata(n) {
    var t = "/" + n[0] + "/" + n[1] + ""
      , i = n[2];
    $.post(t, i, function(n) {
        n.Message != "" ? n.Message == "Login Again" ? location.href = "/" : (fAlert(n.Message),
        typeof fClearPageData == "function" && fClearPageData()) : fillgetdata(n.Data)
    }, "json")
}
function fClose(n) {
...
function fAllowNumeric(n) {
    return varKey = window.event ? window.event.keyCode : n.which,
    varKey >= 48 && varKey <= 57 || varKey == 8 || varKey == 127 || varKey == 0 ? !0 : !1
}
function validateDate(n) {
    var u, t, i, e = new Date, f = new Date, r;
    return (n = stripBlanks(n),
    n == "") ? !1 : n.length < 10 ? !1 : (r = n.split("/"),
    r.length != 3 && (r = n.split("-")),
    r.length != 3 && (r = n.split(".")),
    r.length != 3) ? !1 : (u = r[0],
    t = r[1],
    i = r[2],
    !isNum(u)) ? !1 : isNum(i) ? isNum(t) ? u.length > 2 ? !1 : t.length > 2 ? !1 : i.length > 4 ? !1 : (u = parseFloat(u),
    t = parseFloat(t),
    i = parseFloat(i),
    i < 1753 || i > 2099) ? !1 : (t == 2 && (i % 400 == 0 || i % 4 == 0 && i % 100 != 0) && day[t - 1]++,
    t < 1 || t > 12) ? !1 : u < 1 || u > day[t - 1] ? !1 : (f.setDate(u),
    f.setMonth(t - 1),
    f.setFullYear(i),
    !0) : !1 : !1
}
function stripBlanks(n) {
    ...
    for (i = 0; i < n.length; i++)
        (n.charAt(i) != " " || r > 0) && (u != n.charAt(i) || u != " ") && (t += n.charAt(i),
        u = n.charAt(i),
        n.charAt(i) != " " && (r = t.length));
    return t.substr(0, r)
}
...
function Restrict_Name(n) {
    var t;
    return t = window.event ? window.event.keyCode : n.which,
    t >= 65 && t <= 90 || t >= 97 && t <= 122 || t == 95 || t == 46 || t >= 38 && t <= 44 || t >= 45 && t <= 57 || t == 127 || t == 8 || t == 32 || t == 0 ? !0 : !1
}
function Restrict_Phone(n) {
    var t;
    return t = window.event ? window.event.keyCode : n.which,
    t == 44 || t >= 48 && t <= 57 || t == 8 || t == 127 || t == 0 ? !0 : !1
}
function Restrict_Address(n) {
    var t;
    return t = window.event ? window.event.keyCode : n.which,
    t >= 64 && t <= 90 || t >= 97 && t <= 122 || t == 95 || t == 46 || t >= 38 && t <= 43 || t >= 44 && t <= 57 || t == 127 || t == 8 || t == 32 || t == 0 || t == 35 || t == 92 ? !0 : !1
}
function Restrict_Pincode(n) {
    var t;
    return t = window.event ? window.event.keyCode : n.which,
    t >= 48 && t <= 57 || t == 127 || t == 8 || t == 0 ? !0 : !1
}
function Restrict_Multiline(n, t) {
    var i, r = n || window.event, u = r.target || r.srcElement;
    return (i = window.event ? window.event.keyCode : n.which,
    i == 8 || i == 0) ? !0 : i >= 64 && i <= 90 || i >= 97 && i <= 122 || i == 95 || i == 46 || i >= 38 && i <= 43 || i >= 44 && i <= 57 || i == 127 || i == 8 || i == 32 || i == 0 || i == 35 || i == 92 ? document.getElementById(u.id).value.length < t ? !0 : !1 : !1
}
function pLockControls(n) {
    for (var i = document.getElementById(n).getElementsByTagName("INPUT"), t = 0; t < i.length; t++)
        i[t].type.toLowerCase() == "text" || i[t].type.toLowerCase() == "textarea" ? i[t].readOnly = !0 : (i[t].type.toLowerCase() == "radio" || i[t].type.toLowerCase() == "checkbox") && (i[t].disabled = !0);
    for (i = document.getElementById(n).getElementsByTagName("SELECT"),
    t = 0; t < i.length; t++)
        i[t].id != "lstCDisplay" && (i[t].disabled = !0);
    for (i = document.getElementById(n).getElementsByTagName("textarea"),
    t = 0; t < i.length; t++)
        i[t].readOnly = !0;
    for (i = document.getElementById(n).getElementsByTagName("button"),
    t = 0; t < i.length; t++)
        i[t].disabled = !0
}
function pUnLockControls(n) {
    for (var i = document.getElementById(n).getElementsByTagName("INPUT"), t = 0; t < i.length; t++)
        i[t].type.toLowerCase() == "text" || i[t].type.toLowerCase() == "textarea" ? i[t].readOnly = !1 : (i[t].type.toLowerCase() == "radio" || i[t].type.toLowerCase() == "checkbox") && (i[t].disabled = !1);
    for (i = document.getElementById(n).getElementsByTagName("SELECT"),
    t = 0; t < i.length; t++)
        i[t].disabled = !1;
    for (i = document.getElementById(n).getElementsByTagName("textarea"),
...
function pClearFields(n, t) {
    var r, i;
    try {
        for (r = document.getElementById(n).getElementsByTagName("INPUT"),
        i = 0; i < r.length; i++)
            (t == null || t.indexOf(r[i].id) < 0 || t == "undefined") && (r[i].type.toLowerCase() == "text" || r[i].type.toLowerCase() == "textarea" || r[i].type.toLowerCase() == "hidden" ? r[i].value = "" : r[i].type.toLowerCase() == "checkbox" && (r[i].checked = !1));
        for (r = document.getElementById(n).getElementsByTagName("SELECT"),
        i = 0; i < r.length; i++)
            r[i].selectedIndex = 0;
        for (r = document.getElementById(n).getElementsByTagName("textarea"),
        i = 0; i < r.length; i++)
            r[i].value = ""
    } catch (u) {
        fAlert(u.message)
...
function Restrict_Money(n) {
    var t;
    return t = window.event ? window.event.keyCode : n.which,
    t >= 48 && t <= 57 || t == 127 || t == 46 || t == 8 || t == 0 ? !0 : !1
}
function ConvertDateToYYYYMMDD(n) {
    ...
    n = stripBlanks(n);
    var t = n.split("/");
    return t.length != 3 && (t = n.split("-")),
    t.length != 3 && (t = n.split(".")),
    t[2] + "/" + t[1] + "/" + t[0]
}
...
function fNumber(n, t) {
    var i, f, u, r;
    if (i = window.event ? window.event.keyCode : t.which,
    f = event.target || event.srcElement,
    i == 44) {
        if (stripBlanks(f.value).length < 10)
            return alert("Please Enter 10 digit Mobile No"),
            !1;
        for (u = stripBlanks(f.value).split(","),
        r = 0; r < u.length; r++)
            if (u[r].length < 10 || u[r].length > 10)
                return alert("Please Enter 10 digit Mobile No"),
                !1
    } else
        return i >= 48 && i <= 57 || i == 32 || i == 127 || i >= 40 && i <= 41 || i == 8 || i == 0 ? !0 : !1
}
function RestrictEnterDate(n) {
    var i, r = n || window.event, t;
    return (i = window.event ? window.event.keyCode : n.which,
    t = r.target || r.srcElement,
    (t.value.length == 2 || t.value.length == 5) && (t.value = t.value + "/"),
    i == 47 || i == 45 || i == 46) ? !1 : Restrict_Date(n)
}
function Restrict_Date(n) {
    var t;
    return t = window.event ? window.event.keyCode : n.which,
    t >= 45 && t <= 57 || t == 127 || t == 8 || t == 0 ? !0 : !1
}
function Restrict_MoneyWithPercentage(n) {
    ...
    var r = n || window.event
      ...
      , i = u.value.split(".");
    return i.length > 1 && t == 46 ? !1 : (i = u.value.split("%"),
    i.length > 1 && t == 37) ? !1 : t == 46 || t == 37 || t >= 48 && t <= 57 || t == 8 || t == 127 ? !0 : !1
}
...
function convertjsonTime(n) {
    if (n != null && n.length > 10) {
        var r = n.substr(6)
          , i = new Date(parseInt(r))
          , t = new Date(i.getTime() + 6e4 * i.getTimezoneOffset() + 36e5 * 5.5)
          , u = t.getMinutes().toString().length == 1 ? "0" + t.getMinutes().toString() : t.getMinutes().toString()
          , f = t.getHours().toString().length == 1 ? "0" + t.getHours().toString() : t.getHours().toString();
        return f + ":" + u
    }
    return ""
}
function GetScreenPosition(n) {
    var t = {};
    for (t.x = n.offsetLeft,
    t.y = n.offsetTop + n.offsetHeight; n.offsetParent; )
        if (t.x = t.x + n.offsetParent.offsetLeft,
        t.y = t.y + n.offsetParent.offsetTop,
...
function fDisplayMessage(n, t, i) {
    i == null || i == 0 ? (document.getElementById("sp-error").innerHTML = t,
    $("#" + n).parent().addClass("has-error"),
    document.getElementById(n).focus()) : (document.getElementById("sp-error").innerHTML = t,
    $("#" + n.replace("ID", "Name")).parent().addClass("has-error"),
    document.getElementById("btn" + n).focus())
}
function fFillSection() {
    return document.getElementById("CLID").value == "0" || stripBlanks(document.getElementById("CLID").value) == "" ? (fAlert("Please Select Class"),
    document.getElementById("CLID").focus(),
    !1) : (document.getElementById("TSectionIDs").href = "/Campus/DDLPopUp?strid=TSectionID^" + document.getElementById("CLID").value,
    document.getElementById("TSectionIDs").click(),
    !1)
}
function fAllowNumericMinus(n) {
    if (varKey = window.event ? window.event.keyCode : n.which,
    varKey >= 48 && varKey <= 57 || varKey == 8 || varKey == 127 || varKey == 0)
        return !0;
    if (varKey == 45) {
        var t = n.target.value;
        if (t.indexOf("-") < 0) {
            if (n.target.selectionStart == 0)
                return !0
        } else if (n.target.selectionStart != n.target.selectionEnd && n.target.selectionStart == 0)
            return !0
    }
    return !1
}
function fFillCheckBoxList(n, t) {
    ...
    i.length > 0 ? $.post("/Campus/GetCheckBoxList", {
        ...
        var r, i, u;
        if (n.Message != "")
            n.Message == "Login Again" ? location.href = "/" : alert(n.Message);
        else {
            for (r = "",
            i = 0; i < n.Data[0].length; i++)
                u = '<label class="checkbox-inline" style="width:130px; margin-left:2px;"><input type="checkbox" name="chk_' + n.Data[0][i].CheckName + '" class="chk_' + t + '" oncontextmenu="return fSelectDeSelectMenu(event,\'chk_' + t + '\');" id="chk_' + t + "_" + n.Data[0][i].CheckID + '">' + n.Data[0][i].CheckName + "<\/label>",
                r = r + u;
            $("#div_" + t).html(r)
        }
    }, "json") : $("#div_" + t).html("")
...
function GetCheckCollection(n) {
    for (var r = [], i, t = 0; t < $(".chk_" + n).length; t++)
        i = $(".chk_" + n)[t],
        i.checked == !0 && r.push(i.id.replace("chk_" + n + "_", ""));
    return r
}
function GetCheckValue(n) {
    for (var t = "", r, i = 0; i < $(".chk_" + n).length; i++)
        r = $(".chk_" + n)[i],
        r.checked == !0 && (t = t + "," + r.id.replace("chk_" + n + "_", ""));
...
function GetCheckName(n) {
    for (var t = "", r, i = 0; i < $(".chk_" + n).length; i++)
        r = $(".chk_" + n)[i],
        r.checked == !0 && (t = t + " ," + r.name.replace("chk_", ""));
    return t.length > 0 && (t = t.substring(1, t.length)),
    t
}
function SpanGridViewRow(n, t) {
    for (var f, i, u = t.split(","), r = 0; r < u.length; r++) {
        for (f = 1,
        i = 1; i < document.getElementById(n).rows.length - 1; i++)
            GetCellDataForRowSpan(document.getElementById(n).rows[f], document.getElementById(n).rows[i + 1], Number(u[r])) ? (document.getElementById(n).rows[f].cells[u[r]].rowSpan += 1,
            document.getElementById(n).rows[f].cells[u[r]].style = "vertical-align: middle;",
            document.getElementById(n).rows[i + 1].cells[u[r]].outerHTML = "") : f = i + 1,
            document.getElementById(n).rows[i].cells.length > Number(u[r]) && (document.getElementById(n).rows[i].cells[u[r]].innerHTML.toLowerCase() == "total" || document.getElementById(n).rows[i].cells[u[r]].innerHTML.toLowerCase() == "grand total") && $(document.getElementById(n).rows[i]).attr("style", "font-weight: bold;");
...
function SetCookieForReport() {
    var r, t, n, i;
    if (document.cookie = "",
    document.getElementById("divCheckBoxList") != null)
        for (t = 0; t < document.getElementById("divCheckBoxList").getElementsByTagName("div").length; t++)
            n = document.getElementById("divCheckBoxList").getElementsByTagName("div")[t].id,
            n.indexOf("div_") == 0 && (r = n.replace("div_", ""),
            document.cookie = r + "=" + GetCheckValue(r) + ";path=/",
            document.cookie = r + "_Name=" + GetCheckName(r) + ";path=/");
    if (document.getElementsByClassName("divTextBox") != null) {
        for (t = 0; t < $(".divTextBox").find("input").length; t++)
            n = $(".divTextBox").find("input")[t].id,
            n.indexOf("txt_") == 0 && (i = n.replace("txt_", ""),
            document.cookie = i + "=" + document.getElementById(n).value + ";path=/");
        for (t = 0; t < $(".divTextBox").find("input").length; t++)
            n = $(".divTextBox").find("input")[t].id,
            n.indexOf("ddl_") == 0 && (i = n.replace("ddl_", ""),
            document.cookie = i + "=" + document.getElementById(n).value + ";path=/",
            document.cookie = i + "_Name=" + document.getElementById(n).options[document.getElementById(n).selectedIndex].innerHTML + ";path=/")
    }
    if (document.getElementById("divDropDownList") != null)
        for (t = 0; t < document.getElementById("divDropDownList").getElementsByTagName("SELECT").length; t++)
            n = document.getElementById("divDropDownList").getElementsByTagName("SELECT")[t].id,
            n.indexOf("ddl_") == 0 && (i = n.replace("ddl_", ""),
            document.cookie = i + "=" + document.getElementById(n).value + ";path=/",
            document.cookie = i + "_Name=" + document.getElementById(n).options[document.getElementById(n).selectedIndex].innerHTML + ";path=/")
}
...
function pad_with_zeros(n, t) {
    var i = n.toString(), f = i.indexOf("."), r, u;
    if (f == -1 ? (decimal_part_length = 0,
    i += t > 0 ? "." : "") : decimal_part_length = i.length - f - 1,
    r = t - decimal_part_length,
    r > 0)
        for (u = 1; u <= r; u++)
            i += "0";
    return i
...
function GetCellDataForRowSpan(n, t, i) {
    ...
    if (n.cells.length > i) {
        for (r = i; r >= 0; r--)
            u += n.cells[r].innerHTML + "^",
            f += t.cells[r].innerHTML + "^";
        if (u == f)
            return !0
    }
    return !1
...
function fSelectDeSelectMenu(n, t, i) {
    var r = {}, u, f;
    return r = document.getElementById("divSelectDeSelect"),
    u = getPosition(n).x,
    f = getPosition(n).y,
    r.style.position = "absolute",
    r.style.top = String(f) + "px",
    r.style.left = String(u) + "px",
    r.style.display = "inline",
    classname = t != null ? t : "chk",
    StartPosition = i != null ? i : 0,
    !1
}
...
function fSelectDeSelectAll(eType) {
    var i;
    if (eType == 1)
        for (i = StartPosition; i < $("." + classname).length; i++)
            $("." + classname)[i].disabled == !1 && ($("." + classname)[i].checked = !0);
    else
        for (i = StartPosition; i < $("." + classname).length; i++)
            $("." + classname)[i].disabled == !1 && ($("." + classname)[i].checked = !1);
    return document.getElementById("divSelectDeSelect").style.display = "none",
    $("." + classname).length > 0 && $("." + classname)[0].onclick != null && eval($("#" + $("." + classname)[0].id).attr("onclick")),
    !1
}
function fApplyToAllMenu(n, t, i, r, u) {
    var f = {}, e, o;
    return f = document.getElementById("divApplyToAll"),
    e = getPosition(n).x,
    o = getPosition(n).y,
    f.style.position = "absolute",
    f.style.top = String(o) + "px",
    f.style.left = String(e) + "px",
...
function fApplyToAll() {
    if (typeof fApplyToAll_Child == "function")
        ...
        for (var n = varRow; n < document.getElementById(varContrlName).rows.length - 1; n++)
            varType == "INPUT" ? document.getElementById(varContrlName).rows[n + 1].cells[varCell].getElementsByTagName("INPUT")[0].value = document.getElementById(varContrlName).rows[n].cells[varCell].getElementsByTagName("INPUT")[0].value : document.getElementById(varContrlName).rows[n + 1].cells[varCell].getElementsByTagName("SELECT")[0].value = document.getElementById(varContrlName).rows[n].cells[varCell].getElementsByTagName("SELECT")[0].value
    }
    return document.getElementById("divApplyToAll").style.display = "none",
    !1
}
...
function CompareDate(n, t) {
    ...
    t = stripBlanks(t),
    i = n.split("/"),
    i.length != 3 && (i = n.split("-")),
    i.length != 3 && (i = n.split(".")),
    r = t.split("/"),
    r.length != 3 && (r = t.split("-")),
    r.length != 3 && (r = t.split(".")),
    u = parseFloat(i[0]),
    f = parseFloat(i[1]),
    e = parseFloat(i[2]),
    ...
    s = parseFloat(r[1]),
    h = parseFloat(r[2]),
    e < h) ? 1 : e > h ? 2 : f < s ? 1 : f > s ? 2 : u < o ? 1 : u > o ? 2 : 0
}
...
function getHTMLReportFilterVal() {
    ...
    if (document.getElementById("divCheckBoxList") != null)
        for (n = 0; n < document.getElementById("divCheckBoxList").getElementsByTagName("div").length; n++)
            if (t = document.getElementById("divCheckBoxList").getElementsByTagName("div")[n].id,
            t.indexOf("div_") == 0) {
...
function fFeeLoad() {
    if (document.getElementById("btnFIID") != null && document.getElementById("FGID") != null) {
        ...
        $("#btnFIID").on("click", function() {
            return document.getElementById("btnFGID") != null && (document.getElementById("FGID").value == "" || document.getElementById("FGID").value == "0") ? (fDisplayMessage("FGID", "Please select Fee Group First", 1),
            !1) : document.getElementById("hidtxtSearchName") != null && (document.getElementById("hidtxtSearchName").value == "" || document.getElementById("hidtxtSearchName").value == "0") ? (fDisplayMessage("FNo", "Please select Student First"),
            !1) : ($("#btnFIID").attr("href", "/Campus/DDLPopUp?strid=FGFIID^" + document.getElementById("FGID").value + "&ctrlid=FIID"),
            !0)
        })
    }
}
...
function fINVFillCheckBoxList(n, t) {
    ...
    i.length > 0 ? $.post("/Campus/GetCheckBoxList", {
        ...
        if (n.Message != "")
            ...
            for (r = "",
            u = "",
            t == "Stock_Group" && (u = "Stock_Ledger"),
            t == "Stock_Ledger" && (u = "Item"),
            i = 0; i < n.Data[0].length; i++)
                f = '<label class="checkbox-inline" style="width:130px; margin-left:2px;"><input type="checkbox" name="chk_' + n.Data[0][i].CheckName + '" class="chk_' + t + '"  onclick=" fINVFillCheckBoxList( \'' + t + "' ,'" + u + "');\" oncontextmenu=\"return fSelectDeSelectMenu(event,'chk_" + t + '\');" id="chk_' + t + "_" + n.Data[0][i].CheckID + '">' + n.Data[0][i].CheckName + "<\/label>",
                r = r + f;
            $("#div_" + t).html(r)
        }
    }, "json") : $("#div_" + t).html("")
}
function SearchGriddata(n, t, i) {
    var r = $(n).val().toUpperCase();
    $("#page_navigation").hide();
    $("#" + t + " tbody tr ").each(function() {
        $(this).text().toUpperCase().indexOf(r) > -1 || $(this).text().toLowerCase().indexOf(r) > -1 ? $(this).show() : $(this).hide()
    });
    r == "" && (Custom_Pagination(t, i, 5),
    $("#page_navigation").show())
}
function Custom_Pagination(n, t, i) {
    var o, f, e, u, r, s;
    if (o = $("#" + n + " tbody tr").size(),
    $("#page_navigation").show(),
    o <= t)
        return $("#page_navigation").hide(),
        !1;
    for (f = Math.ceil(o / t),
    $("#current_page").val(1),
    $("#show_per_page").val(t),
    e = '<a id="FirstId"  style="margin-left: 2px;" class="page_link btn btn-info" href="javascript:first()">First<\/a>',
    e += '<a  id="PreId"  style="margin-left: 2px;" class="previou_link  btn btn-info" href="javascript:callPrev();" title="Previous Page"> << <\/a>',
    u = 1; f >= u; )
        e += u <= i ? '<a id="pageId_' + u + '" style="margin-left: 2px;" class="btnfirstShow page_link btn btn-info" href="javascript:showPage(' + u + ')" longdesc="' + u + '">' + u + "<\/a>" : '<a id="pageId_' + u + '"  style="margin-left: 2px;" class="btnlastShow page_link btn btn-info" href="javascript:showPage(' + u + ')" longdesc="' + u + '">' + u + "<\/a>",
        u++;
    for (e += '<a  id="NexId"  style="margin-left: 2px;"  class="previou_link  btn btn-info" href="javascript:next();" title="Next Page"> >> <\/a>',
    f < u && (e += '<a id="Lastid"  style="margin-left: 2px;" class=" page_link  btn btn-info" href="javascript:last(' + f + ')">Last<\/a>'),
    $("#page_navigation").html(e),
    $(".btnlastShow").hide(),
    $("#" + n + " tbody tr").hide(),
    r = 0; r < t; r++)
        $("#" + n + " tbody tr").eq(r).show();
    s = t;
    $("#FirstId").hide();
    $("#PreId").hide();
    showPage = function(t) {
        ...
        AddAcitveCss(t),
        t > 1 ? ($("#FirstId").show(),
        $("#PreId").show()) : $("#FirstId").hide(),
        $("#NexId").show(),
        $("#Lastid").show(),
        t == 1 ? $("#PreId").hide() : t == f ? ($("#NexId").hide(),
        $("#Lastid").hide(),
        $("#FirstId").show()) : $("#PreId").show(),
        t >= i) {
            var u = 0;
            if (t > i && (u = t - i),
            t == f)
                for (r = 1; r <= t; r++)
                    r <= u ? $("#pageId_" + r).hide() : $("#pageId_" + r).show()
        }
        $("#" + n + " tbody tr").each(function(n) {
            n >= s * (t - 1) && n < s * t && $(this).show()
        })
    }
    ;
    callPrev = function() {
    ...
    Pagination = function(n) {
        ...
        if (f > i)
            for (r = 1; r <= f; r++)
                n > r && u > r ? $("#pageId_" + r).hide() : t > r ? $("#pageId_" + r).show() : $("#pageId_" + r).hide();
        else
            $("#PreId").show()
    }
}
function serachonload(n, t) {
    var f = $(".searchbox-icon")
      , r = $(".searchbox-input")
      , u = $(".searchbox")
      , i = !1;
    f.click(function() {
        i == !1 ? (u.addClass("searchbox-open"),
        r.focus(),
        i = !0) : (u.removeClass("searchbox-open"),
        r.focusout(),
        i = !1)
    });
    $("#ddlGridSearch").attr("onkeyup", "return SearchGriddata(this, '" + n + "'," + t + ");");
    Custom_Pagination(n, t, 5)
}
...
window.Modernizr = function(n, t, i) {
    ...
    var u = {}, d = !0, s = t.documentElement, e = "modernizr", ft = t.createElement(e), c = ft.style, o = t.createElement("input"), g = ":)", et = {}.toString, y = " -webkit- -moz- -o- -ms- ".split(" "), ot = "Webkit Moz O ms", st = ot.split(" "), ht = ot.toLowerCase().split(" "), p = {
        svg: ""
    }, r = {}, ct = {}, w = {}, nt = [], tt = nt.slice, b, a = function(n, i, r, u) {
...
function(n) {
    function r() {
        ...
        "function" == typeof n[t] ? "paste" : "input"
    }
    var t, u = r() + ".mask", i = navigator.userAgent, f = /iphone/i.test(i), e = /android/i.test(i);
    n.mask = {
        definitions: {
            9: "[0-9]",
            a: "[A-Za-z]",
    ...
    n.fn.extend({
        ...
        mask: function(i, r) {
            var a, l, o, h, c, s;
            return !i && this.length > 0 ? (a = n(this[0]),
            a.data(n.mask.dataName)()) : (r = n.extend({
            ...
            n.each(i.split(""), function(n, t) {
                "?" == t ? (s--,
                h = n) : l[t] ? (o.push(RegExp(l[t])),
                null === c && (c = o.length - 1)) : o.push(null)
            }),
            this.trigger("unmask").each(function() {
                ...
                function tt(n) {
                    var u, i, t, r = n.which;
                    8 === r || 46 === r || f && 127 === r ? (u = a.caret(),
                    i = u.begin,
                    t = u.end,
                    0 == t - i && (i = 46 !== r ? g(i) : t = y(i - 1),
                    t = 46 === r ? y(t) : t),
                    b(i, t),
                    d(i, t - 1),
                    n.preventDefault()) : 27 == r && (a.val(k),
                    a.caret(0, w()),
                    n.preventDefault())
                }
                function it(t) {
                    var u, h, f, c = t.which, i = a.caret();
                    t.ctrlKey || t.altKey || t.metaKey || 32 > c || c && (0 != i.end - i.begin && (b(i.begin, i.end),
                    d(i.begin, i.end - 1)),
                    u = y(i.begin - 1),
                    s > u && (h = String.fromCharCode(c),
                    o[u].test(h) && (nt(u),
                    v[u] = h,
                    p(),
                    f = y(u),
                    e ? setTimeout(n.proxy(n.fn.caret, a, f), 0) : a.caret(f),
                    r.completed && f >= s && r.completed.call(a))),
                    t.preventDefault())
                }
                function b(n, t) {
                    for (var i = n; t > i && s > i; i++)
                        o[i] && (v[i] = r.placeholder)
                }
                function p() {
                    a.val(v.join(""))
                }
                function w(n) {
                    ...
                    pos = 0; s > t; t++)
                        if (o[t]) {
                            ...
                            v[t] === i.charAt(pos) && t !== h && (pos++,
                            u = t);
                    return n ? p() : h > u + 1 ? (a.val(""),
                    b(0, s)) : (p(),
                    a.val(a.val().substring(0, u + 1))),
                    h ? t : c
                }
                var a = n(this)
                  , v = n.map(i.split(""), function(n) {
                    if ("?" != n)
                        return l[n] ? r.placeholder : n
                })
                  , k = a.val();
